...
dockerize -wait tcp://write-home-timeline-rabbitmq-us:5672 -wait tcp://write-home-timeline-rabbitmq-eu:5672 -wait-retry-interval 10s -timeout 300s echo "[INFO] write-home-timeline-rabbitmq ready!"
