...
dockerize -wait tcp://post-storage-mongodb-eu:27017 -wait tcp://post-storage-mongodb-us:27017 -wait-retry-interval 10s -timeout 300s echo "[INFO] mongodb cluster ready!"
